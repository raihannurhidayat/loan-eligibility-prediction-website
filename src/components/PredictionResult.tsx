  ...
  return (
    ...
    >
      ...
      <div className="flex items-start justify-between gap-4">
        <div className="flex flex-col gap-1">
          ...
          <div className="flex items-center gap-3 mt-1">
            {isGood ? (
              <CheckCircle2 className="h-8 w-8 text-good shrink-0" aria-hidden="true" />
            ) : (
              <XCircle className="h-8 w-8 text-bad shrink-0" aria-hidden="true" />
            )}
            <h2
              className={cn(
        ...
        >
          ...
          {Math.round((isGood ? result.probability_good : result.probability_bad) * 100)}% Confidence
        </Badge>
      </div>
      ...
      <p className="text-xs text-muted-foreground leading-relaxed">
        Prediction generated by a Random Forest model (accuracy 79%, ROC-AUC 0.83).
        This result is for reference only and does not constitute a formal credit decision.
      </p>
    </div>
  );
}
